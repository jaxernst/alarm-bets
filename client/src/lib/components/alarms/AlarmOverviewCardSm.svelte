...
<div class="grid grid-cols-[62%_1fr]">
	<div class="flex h-full flex-col items-start justify-center overflow-visible">
		<div class="relative flex pt-1" style="font-size: 1.95em; line-height: .85em">
			<ClockDisplay overrideTime={timeString(alarmTime)} overrideColor={'orange'} />
...
{#if timeToNextDeadline}
	<div class="overflow-visible whitespace-nowrap pl-1 text-xs" style="line-height: .8em">
